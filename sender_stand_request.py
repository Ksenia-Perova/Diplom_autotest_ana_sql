# Перова Ксения,11 когорта,дипломный проект-инженер по тестированию плюс
...
def get_order_by_track(order_track_number):
    return requests.get(configuration.URL_SERVICE + configuration.GET_ORDER + str(order_track_number))
